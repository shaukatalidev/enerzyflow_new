        ...
        {step < 4 && (
          <div className="mb-10">
            <div className="flex justify-between items-end mb-2">
              <span className="text-[#00F0FF] text-[10px] font-black uppercase tracking-[0.3em]">Franchise Onboarding</span>
              <span className="text-gray-500 text-[10px] font-bold uppercase">Step {step} of 3</span>
            </div>
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          {step === 1 && (
            <div className="animate-in slide-in-from-bottom-4 duration-500 fade-in">
              <h2 className="text-3xl font-bold mb-6 font-sans">Let's start with <span className="text-[#00F0FF]">You.</span></h2>
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 ml-1">Mobile Number</label>
                  <input 
                    type="tel" 
                    className="w-full bg-white/5 border border-white/10 text-white p-4 rounded-2xl outline-none focus:border-[#00F0FF] focus:bg-[#00F0FF]/5 focus:shadow-[0_0_15px_rgba(0,242,255,0.1)] transition-all duration-300" 
                    placeholder="+91" 
          ...
          {step === 2 && (
            <div className="animate-in slide-in-from-bottom-4 duration-500 fade-in">
              <h2 className="text-3xl font-bold mb-6 font-sans">Target <span className="text-[#00F0FF]">Territory.</span></h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 ml-1">Proposed City</label>
                  <input 
                    type="text" 
                    className="w-full bg-white/5 border border-white/10 text-white p-4 rounded-2xl outline-none focus:border-[#00F0FF] focus:bg-[#00F0FF]/5 focus:shadow-[0_0_15px_rgba(0,242,255,0.1)] transition-all duration-300" 
                ...
                <div>
                  <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 ml-1">Logistics Capacity</label>
                  <select className="w-full bg-white/5 border border-white/10 text-white p-4 rounded-2xl outline-none focus:border-[#00F0FF] focus:bg-[#00F0FF]/5 transition-all duration-300 appearance-none cursor-pointer">
                    <option className="bg-black text-gray-300">I have storage space/warehouse</option>
                    <option className="bg-black text-gray-300">I can lease a space</option>
                    <option className="bg-black text-gray-300">I need guidance on setup</option>
                  </select>
                </div>
              </div>
          ...
          {step === 3 && (
            <div className="animate-in slide-in-from-bottom-4 duration-500 fade-in">
              <h2 className="text-3xl font-bold mb-6 font-sans">Final <span className="text-[#00F0FF]">Check.</span></h2>
              <div className="space-y-4">
                <p className="text-gray-400 text-sm leading-relaxed">
                  Are you ready to commit to a monthly target of <b className="text-white">500 cases</b> and an initial setup fee of <b className="text-white">₹80,999</b>?
                </p>
                
                <div 
                  className={`flex items-center gap-3 p-4 bg-[#00F0FF]/5 rounded-2xl border transition-colors duration-300 ${showError ? 'border-red-500 animate-[shake_0.5s_ease-in-out]' : 'border-[#00F0FF]/20'}`}
                  style={showError ? { animation: 'shake 0.4s cubic-bezier(.36,.07,.19,.97) both' } : {}}
                >
                  <input 
                    type="checkbox" 
                    id="agreement"
                  ...
                  />
                  <label htmlFor="agreement" className="text-xs text-gray-300 cursor-pointer select-none">
          ...
          {step === 4 && (
            <div className="text-center animate-in zoom-in-95 duration-500 fade-in">
              ...
              <h2 className="text-3xl font-bold mb-4 font-sans">Application <span className="text-[#00F0FF]">Received.</span></h2>
              <p className="text-gray-400 text-sm mb-8">Our territory managers will review your profile and reach out within 24 business hours.</p>
              <button 
                type="button" 
                onClick={handleReset} 
