...
export default function Login() {
  const [email, setEmail] = useState('rakesh@energyflow.com');
  ...
  const handleGoogleLogin = () => {
    console.log('Continue with Google login');
  };

  const handlePhoneLogin = () => {
    console.log('Continue with Phone Number login');
  };
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="rakesh@energyflow.com"
                value={email}
