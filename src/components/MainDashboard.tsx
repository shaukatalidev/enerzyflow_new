...
const OrderCard = memo(
  ({ order, onClick }: { order: Order; onClick: () => void }) => {
    return (
            ...
            <div className="flex-1 min-w-0">
              ...
              {order.payment_status === "payment_rejected" && (
                <div className="mt-2 flex items-center text-xs text-red-600">
                  ...
                  Payment rejected -{" "}
                  {order.decline_reason || "Click to reupload"}
                </div>
              )}
...
export default function MainDashboard() {
  ...
  const handleOrderClick = useCallback(
    (orderId: string) => {
      ...
      router.push(`/dashboard/order/${orderId}/status`);
    },
    [orders, router]
  );
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                  <div className="text-center">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mb-2">
                      {categorizedOrders.active.all.length}
                    </p>
                ...
                <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                  <div className="text-center">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mb-2">
                      {categorizedOrders.rejected.all.length}
                    </p>
                ...
                <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                  <div className="text-center">
                    ...
                    <p className="text-3xl font-bold text-gray-900 mb-2">
                      {categorizedOrders.completed.all.length}
                    </p>
