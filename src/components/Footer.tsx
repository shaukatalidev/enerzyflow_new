      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold mb-6 tracking-tighter">
            Ready to{" "}
            <span className="text-brand text-cyan-400 text-glow">Flow?</span>
          </h2>

          <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-xl mx-auto">
            Transforming bottles into branding powerhouses. Turn your water
            bottles into your most profitable brand asset with premium design
            and smart QR integration.
          </p>
          <Link
            href="https://discover.enerzyflow.com"
            target="_blank"
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 ">
          ...
          <div className="footer-left flex flex-col gap-6 text-gray-400 text-sm">
            ...
            >
              ...
              <span className="whitespace-nowrap">9002520720 (9AM–9PM)</span>
            </a>
