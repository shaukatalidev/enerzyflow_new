...
const SectionHeading = ({ title, highlight, subtitle }: { title: string, highlight: string, subtitle: string }) => (
  <div className="text-center max-w-3xl mx-auto mb-20">
    ...
    >
      {title} <span className="text-brand drop-shadow-[0_0_15px_rgba(0,240,255,0.5)]">{highlight}</span>
    </motion.h2>
    <motion.p 
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
...
export default function FranchisePage() {
  ...
  return (
    <div className={`${inter.variable} ${spaceGrotesk.variable} bg-dark text-white font-sans overflow-x-hidden selection:bg-brand selection:text-black min-h-screen cursor-none`}>
        ...
        <div className="container mx-auto px-6 md:px-10 relative z-10 grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-bold leading-[0.9] mb-8 font-heading">
              Own the <span className="text-cyan-400 italic drop-shadow-[0_0_15px_rgba(0,240,255,0.5)]">Flow.</span><br />
              Scale the City.
            </h1>
            <p className="text-gray-400 text-xl max-w-lg leading-relaxed mb-12">
              Launch your own <b>Customised Water Bottle</b> business. We handle manufacturing and tech; You handle sales and distribution. <br />
              <span className="text-white font-bold block mt-4 font-heading underline decoration-brand/30 underline-offset-8">Zero Competition. Exclusive Territory Lock.</span>
            </p>
            ...
            <div className="flex flex-wrap gap-8 items-center">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-2xl font-bold text-white leading-none font-heading">Turnkey</p>
                  <p className="text-[10px] text-gray-500 uppercase tracking-widest font-heading">Ready Setup</p>
                </div>
                <div className="h-8 w-px bg-white/20"></div>
                <div className="text-left">
                  <p className="text-2xl font-bold text-cyan-400 leading-none font-heading">₹81k</p>
                  <p className="text-[10px] text-gray-500 uppercase tracking-widest font-heading">One-time Fee</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative w-full max-w-md aspect-square rounded-[40px] border border-brand/30 bg-surface/50 backdrop-blur-xl flex flex-col items-center justify-center p-10 overflow-hidden group hover:border-brand/60 transition-colors">
              ...
              <h3 className="text-2xl font-bold text-center mb-2 font-heading">Exclusive Sales Partner</h3>
              <p className="text-center text-gray-500 text-sm mb-8">You control the relationships. We control the supply.</p>
              ...
              <div className="w-full bg-surface p-4 rounded-xl border border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="text-xs text-white font-bold font-heading">Full Support</p>
                    <p className="text-[10px] text-gray-500">Brand + Leads + Logistics</p>
                  </div>
                </div>
      ...
      <section id="earnings" className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-10 grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            >
              High Velocity <span className="text-brand drop-shadow-[0_0_15px_rgba(0,240,255,0.5)]">Earnings.</span>
            </motion.h2>
            
            <div className="space-y-6">
              {[
                { label: 'Franchise Fee', value: 'get code', icon: FaHandshake, sub: null },
                { label: 'Monthly Commitment', value: '500 Cases', icon: null, sub: '~12,000 Bottles' },
              ].map((item, idx) => (
                <motion.div 
                  key={idx}
...
>
  ...
  <FaRocket className="text-4xl text-brand animate-bounce" />
              ...
              <p className="mt-6 text-gray-500 text-sm italic">
                * ROI based on average sales turnover from current Tier-2 city partners.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <h3 className="text-2xl font-bold mb-10 relative z-10 font-heading tracking-wide">The Profit Engine</h3>
            ...
            <div className="flex items-end justify-center gap-6 h-72 mb-8 relative z-10">
              <div className="w-24 bg-gray-800 rounded-t-2xl relative group h-[50%] transition-all hover:h-[55%]">
                <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-xs font-bold text-gray-500 uppercase tracking-tighter">Purchase</span>
              </div>
              <div className="w-24 bg-cyan-400 rounded-t-2xl relative group h-[85%] shadow-[0_0_40px_rgba(0,242,255,0.4)] transition-all hover:h-[90%]">
                <span className="absolute -top-10 left-1/2 -translate-x-1/2 text-lg font-bold text-brand font-heading">Margin</span>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed relative z-10 max-w-sm mx-auto">
              You earn on the spread between manufacturing cost and wholesale distribution price. Consistent re-orders = Stable income.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 md:px-10 max-w-4xl">
          ...
          >
            {[
              ...
              { label: "Target City / Zone", type: "text", placeholder: "e.g. Surat, Pune, Ludhiana", full: true }
            ].map((field, idx) => (
              <div key={idx} className={field.full ? "col-span-2" : "col-span-2 md:col-span-1"}>
                <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] mb-3 font-heading">{field.label}</label>
                <input 
                  type={field.type} 
            ...
            <div className="col-span-2">
              <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] mb-3 font-heading">Experience in Sales/Logistics?</label>
              <div className="relative">
                <select 
                  ...
                  onMouseLeave={() => setIsHovering(false)}
                >
                  <option className="bg-black text-gray-300">Yes, I am experienced</option>
                  <option className="bg-black text-gray-300">No, but I have a network</option>
                  <option className="bg-black text-gray-300">I am a first-time entrepreneur</option>
                </select>
            ...
            <div className="col-span-2 mt-6">
              ...
              <p className="text-center text-[10px] text-gray-600 mt-6 tracking-widest uppercase flex items-center justify-center gap-2">
                <FaShieldHalved /> Confidential Application. Our team will call within soon.
              </p>
            </div>
          </motion.form>
        </div>
